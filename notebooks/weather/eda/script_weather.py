def weather_score_df():
    ...
    data_weather_50_25['date'] = pd.to_datetime(data_weather_50_25['date'], format='%Y%m')
    ...
    data_weather_50_25['year_quarter'] = data_weather_50_25['year'].astype(str) + 'T' + data_weather_50_25['quarter'].astype(str)
    data_weather_50_25['postal_code'] = data_weather_50_25['postal_code'].astype(str).str.zfill(8).str[:5]

    data_weather_14_24 = (
    data_weather_50_25[
        (data_weather_50_25['year'] >= 2014) &
        (data_weather_50_25['year'] < 2025)
    ]
    ...
    data_weather_14_24['heat_score'] = data_weather_14_24['heat_level'].map(risk_mapping)
    data_weather_14_24['rainfall_score'] = data_weather_14_24['rainfall_level'].map(risk_mapping)
    data_weather_14_24['drought_score'] = data_weather_14_24['heat_level'].map(risk_mapping)
    data_weather_14_24['extrem_events_score'] = data_weather_14_24['extrem_events_level'].map(risk_mapping)
    ...
    columns = ['drought_score', 'heat_score', 'rainfall_score', 'extrem_events_score']
    data_risk_weather= (
    data_weather_14_24
    .groupby(['code_commune_INSEE', 'year'])[columns]
    .max()
    .reset_index()
    )
    ...
    # data_weather_14_24['risk_score_level'] = data_weather_14_24['avg_risk_score'].apply(risk_score_level)

    # data_risk_by_dept = (
    # data_weather_14_24
    # .groupby(['nom_departement', 'year_quarter'])['avg_risk_score']
    # .mean()
    # .round(2)
    # .reset_index()
    # )

    # data_insee['code_departement'] = data_insee['code_commune_INSEE'].astype(str).str[:2]
